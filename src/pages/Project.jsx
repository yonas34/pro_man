...
setData([...dataUpdate]);
  ...
  <div>
    ...
    <DialogueForProject open={open}   manData={manPowerData} setData={(data)=>setDataFromDialogueForProject(data)} data={selected} onClose={handleDetailClose} onSave={handleDetailSave}/>
    </div>
  );
}
