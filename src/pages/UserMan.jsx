...
await axios.post("https://www.nrwlpms.com/api/api/update_resourse_type.php",
  {
    ...
    return (
        ...
        options={{actionsColumnIndex:-1,rowStyle: rowData => ({
  ...
  components={{
       ...
       onRowAdd: newData=>
            new Promise((resolve,reject)=>{
                setTimeout(()=>{
                  addResource({equipment:newData.equipment,fule_cons_per_hr:newData.fule_cons_per_hr,rate_hr:newData.rate_hr});
...
updateResource({res_type_id:newData.res_type_id,rate_hr:newData.rate_hr,equipment:newData.equipment,fule_cons_per_hr:newData.fule_cons_per_hr});
