...
import getBase64 from '../component/pp';
...
function EmployeePage() {
  ...
  const column = [
    { title: 'Profile Picture', field: 'imageUrl',editable:'never', render: rowData => <img src={"data:image/jpeg;base64,"+rowData.imageUrl} style={{width: 50, borderRadius: '50%'}}/> },
