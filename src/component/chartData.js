...
return({unstructuredTotal:[{label:"income",previous:response.data["total report"]["total last months income"],this:response.data["total report"]["total this month income"],todate:response.data["total report"]["total todate income"]},{label:"expense",previous:totalPre,this:totalThis,todate:totalTodate}], total:dualData(Object.values({previous:response.data["total report"]["total last months income"],this:response.data["total report"]["total this month income"],todate:response.data["total report"]["total todate income"]}),Object.values({previous:totalPre,this:totalThis,todate:totalTodate})),percent:{previous:gData("previous",pre),this:gData("This Months",thi_s),todate:gData("Todate",todate)}});
})
)
